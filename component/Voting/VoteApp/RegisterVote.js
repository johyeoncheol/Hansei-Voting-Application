...
const RegisterVote = ({ navigation }) => {
   ...
   const _setItems = () => {
      ...
      setItems([...items, { key: items.length, value: "", count: 0 }]);
   };

   const setItemsValue = (text, i) => {
      const oldItems = items;
      oldItems.splice(i, 1, { key: items.length, value: text, count: 0 });
      setItems([...oldItems]);
   };
         ...
         <View style={styles.card}>
            <ScrollView>
               ...
               <View style={styles.TopContent}>
                     ...
                     return (
                        ...
                        >
                           <TextInput
                              ...
                              value={item.value}
                              label={`투표항목 ${i + 1}`}
                              onChange={(text) => setItemsValue(text, i)}
                           ></TextInput>
                           <Button
                              style={{
                                 width: width * 0.1,
                  ...
                  >
                     <Button mode="contained" onPress={_setItems}>
                        항목 추가
                     </Button>
                  </View>
               </View>
