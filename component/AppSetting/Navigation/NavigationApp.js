...
const appDrawer = createDrawerNavigator(
    {
        Home: {
            ...
            navigationOptions: {
                title: "홈",
                drawerIcon: ({ tintColor }) => <HomeIcon name='home' size={16} style={{ color: tintColor }} /> 
            }
        },
        Calendar: {
            screen: Calendar,
            navigationOptions: {
                title: "일정",
                drawerIcon: ({ tintColor }) => <CalendarIcon name='calendar' size={16} style={{ color: tintColor }} />
            }
        },
        Voting: {
            screen: VoteApp,
            navigationOptions: {
                title: "투표하기",
                drawerIcon: ({ tintColor }) => <VoteIcon name='vote' size={16} style={{ color: tintColor }} />
            }
        },
        Suggestion: {
            screen: Suggestion,
            navigationOptions: {
                title: "건의함",
                drawerIcon: ({ tintColor }) => <SuggestionIcon name='comment-alert-outline' size={16} style={{ color: tintColor }} />
            }
        },
        Setting: {
            screen: Setting,
            navigationOptions: {
                title: "설정",
                drawerIcon: ({ tintColor }) => <SettingIcon name='setting' size={16} style={{ color: tintColor }} />,
                headerTitle: () => (
                    <View>
